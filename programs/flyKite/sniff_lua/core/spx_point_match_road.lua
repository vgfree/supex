...
local x_redis_cmd_RL			= perf.mem_function_record( "redis_api_RL", redis_api.cmd, 20 )
local x_redis_cmd_LN			= perf.mem_function_record( "redis_api_LN", redis_api.cmd, 20 )
local x_redis_cmd_RI			= perf.mem_function_record( "redis_api_RI", redis_api.cmd, 20 )
...
local function quick_location( lon, lat, dir, accountID )
	...
	local old_roadID = perf.mem_classify_obtain("sysInternalRoadID", accountID)
	...
	if new_roadID ~= old_roadID then
		perf.mem_classify_record("sysInternalRoadID", accountID, new_roadID)
	end
	return true,result
end
