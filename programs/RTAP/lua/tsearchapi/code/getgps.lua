...
local function check_parameter(args)
        ...
        local errlog = string.format("time interval must less than %d hours. startTime or endTime", timeRangeLimit/3600)
                return false, errlog
        end
        return true
end
...
local function get_data_from_redis(imei, startTime, endTime, gps_tab)
        ...
        for t=startTime, endTime, 600 do
                ...
                -- ok, tab = redis_api.only_cmd("tsdb_redis", "SMEMBERS", key)
...
local function get_data_from_tsdb(imei, startTime, endTime, gps_tab)
        ...
        local t1 = dk_utils.get_tsdb_name(startTime, imei)
        local t2 = dk_utils.get_tsdb_name(endTime, imei)
