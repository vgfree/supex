 ...
 * All Right Reserved
 *
 * @file sample_total.cpp
 * @detail deal with total file for merge one voice
 */
...
{
	int             ret = 0;
	ifstream        in("../testfile/utf8.txt", ios::in);
	...
	sprintf(pcm_filename, "../testfile/pcm_wav/tts_audio.pcm");
	sprintf(wav_filename, "../testfile/pcm_wav/tts_audio.wav");
