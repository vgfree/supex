...
public:
	...
	Bool16 IsHintTrackInitialized()
	{
		return fHintTrackInitialized;
	}
	...
	inline UInt32 GetFirstRTPTimestamp(void)
	{
		return fFirstRTPTimestamp;
	}

	inline void SetAllowInvalidHintRefs(Bool16 inAllowInvalidHintRefs)
	{
	...
	//
	// Packet functions
	inline UInt32 GetRTPTimescale(void)
	{
		return fRTPTimescale;
	}

	inline UInt32 GetRTPTimestampRandomOffset(void)
	{
		return fTimestampRandomOffset;
	}

	inline UInt16 GetRTPSequenceNumberRandomOffset(void)
	{
		return fSequenceNumberRandomOffset;
	}
	...
	inline SInt16 GetHintTrackType(void)
	{
		return fHintType;
	}
