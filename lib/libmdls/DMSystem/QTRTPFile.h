...
public:
	...
	static const RTPMetaInfoPacket::FieldID *GetSupportedRTPMetaInfoFields()
	{
		return kMetaInfoFields;
	}
	...
	void SetAllowInvalidHintRefs(Bool16 inAllowInvalidHintRefs)
	{
	...
	Float64 GetRequestedSeekTime()
	{
		return fRequestedSeekTime;
	}

	Float64 GetActualSeekTime()
	{
		return fSeekTime;
	}
	...
	RTPTrackListEntry *GetLastPacketTrack()
	{
		return fLastPacketTrack;
	}

	UInt32 GetNumSkippedSamples()
	{
		return fNumSkippedSamples;
	}
	...
	Bool16 DropRepeatPackets()
	{
		return fDropRepeatPackets;
	}

	Bool16 SetDropRepeatPackets(Bool16 allowRepeatPackets)
	{
		(!fHasRTPMetaInfoFieldArray) ? fDropRepeatPackets = allowRepeatPackets : fDropRepeatPackets = false; return fDropRepeatPackets;
	}
