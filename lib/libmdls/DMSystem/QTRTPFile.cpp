...
{
	qtss_printf("[QTRTPFile] Initialize .\n");
	QTRTPFile::gFileCacheMutex = NEW        OSMutex();	// 缓存锁
	QTRTPFile::gFileCacheAddMutex = NEW     OSMutex();	// 缓存添加互斥锁
}
...
#endif	// ifdef USE_RTP_TRACK_DURATION
