...
public:
	...
	void SetThreadPicker(unsigned int *picker);		// 设置线程的选择者
...
private:
	...
	static unsigned int     sShortTaskThreadPicker;
...
private:
	...
	static UInt32           sNumTaskThreads;		// 任务池中总的Task的个数
	static UInt32           sNumShortTaskThreads;		// 任务池中ShortTask的个数
	static UInt32           sNumBlockingTaskThreads;	// 任务池中BlockTask的个数
