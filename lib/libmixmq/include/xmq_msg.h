...
/*消息头长度*/
#define MSG_HEAD_SIZE ((size_t)sizeof(xmq_msg_t))
 ...
 * return:             整个消息头+消息体字节数
 * */
#define xmq_msg_total_size(msgptr)      ((size_t)(MSG_HEAD_SIZE + (msgptr)->len))
...
/*xmq_msg_index - 取得消息的索引号
 * @msg:          需要获取消息索引号的消息
 * return:        消息索引号
 * */
#define xmq_msg_index(msgptr) ((uint64_t)((msgptr)->index))
