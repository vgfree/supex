...
/*********************************************************************************************/
#ifndef __COMM_DISPOSE_DATA_H__
#define __COMM_DISPOSE_DATA_H__
...
typedef int (*DISPOSE_DATA_CALLBACK)(char *dst, const char *src, int d_len, int s_len);
...
#endif
#endif	/* ifndef __COMM_DISPOSE_DATA_H__ */
