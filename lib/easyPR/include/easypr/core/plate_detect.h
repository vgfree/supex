...
public:
		...
		inline void setPDLifemode(bool param)
		{
			m_plateLocate->setLifemode(param);
		}
		...
		inline bool getPDDebug()
		{
			return m_plateLocate->getDebug();
		}
		...
		inline void setVerifyMin(int param)
		{
			m_plateLocate->setVerifyMin(param);
		}

		inline void setVerifyMax(int param)
		{
			m_plateLocate->setVerifyMax(param);
		}

		inline void setJudgeAngle(int param)
		{
			m_plateLocate->setJudgeAngle(param);
		}

		inline void setMaxPlates(int param)
		{
			m_maxPlates = param;
		}

		inline int getMaxPlates() const
		{
			return m_maxPlates;
		}
