...
public:
		...
		inline std::string oshort() const
		{
			return option_short;
		}

		inline std::string olong() const
		{
			return option_long;
		}
		...
		inline void oshort(const std::string &oshort)
		{
			option_short = oshort;
		}

		inline void olong(const std::string &olong)
		{
			option_long = olong;
		}
...
public:
		...
		inline void add_usage_line(const Row &row)
		{
		...
		inline void set_first_line(const char *line)
		{
			first_line_ = line;
		}

		inline void set_description(const char *desc)
		{
			description_ = desc;
		}
		...
		inline const char *get_first_line() const
		{
			return first_line_;
		}

		inline Usages::iterator begin()
		{
			return usages_.begin();
		}

		inline Usages::iterator end()
		{
			return usages_.end();
		}
		...
		inline Row &at(size_t i)
		{
			return usages_.at(i);
		}

		inline const Usages &get_usage() const
		{
			return usages_;
		}

		inline static const char *get_default_name()
		{
			return "EmptySubroutine";
		}
...
public:
		...
		inline std::string get_subroutine_name() const
		{
